...
namespace _2DMovementController.Scripts
{
    ...
    {
        [SerializeField] private PlayerEnum _mPlayerRole;
        public PlayerEnum PlayerRole => _mPlayerRole;
    ...
    {
        public PlayerEnum PlayerRole { get; }
